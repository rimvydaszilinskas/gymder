...
urlpatterns = [
    ...
    url(r'^activities/filter/(?P<identifier>\w+)/', views.ActivityTagFilterView.as_view(), name='activity-tag-filter'),
    ...
    url(r'^user/tags/$', views.UserTagsView.as_view(), name='user-tags'),
